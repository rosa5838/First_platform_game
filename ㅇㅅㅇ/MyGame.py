...
background_image = PG.image.load("C:\platformerGraphicsDeluxe_Updated\First_platform_game-main\ㅇㅅㅇ\image\map\BG.png")
background_image = PG.transform.scale(background_image, (xSize, ySize))
bg_image = background_image.get_rect()

# 타일 변수
Grass_mid = PG.image.load("C:\platformerGraphicsDeluxe_Updated\First_platform_game-main\ㅇㅅㅇ\image\Tiles\grassMid.png")
Grass_base = PG.image.load("C:\platformerGraphicsDeluxe_Updated\First_platform_game-main\ㅇㅅㅇ\image\Tiles\grassCenter.png")
...
while not running:
    ...
    screen.blit(background_image, bg_image)
